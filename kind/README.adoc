...
This folder contains the variant to use when deploying locally using a https://github.com/GersonRS/modern-gitops-stack-module-cluster-kind[KinD] cluster and an S3 bucket deployed using the https://github.com/GersonRS/modern-gitops-stack-module-minio[MinIO] module of the https://modern-gitops-stack.io[Modern Gitops Stack].
...
----
module "thanos" {
  source = "git::https://github.com/GersonRS/modern-gitops-stack-module-thanos//kind?ref=<RELEASE>"
